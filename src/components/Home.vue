...
export default {
  ...
  created: function() {
    ...
    lastWeekMonday.setDate(
      lastWeekMonday.getDate() - 7 - ((lastWeekMonday.getDay() + 6) % 7)
    );
  },
  computed: {
    getObject: function() {
    ...
    getBody: function() {
      ...
      result += `<br><br>&nbsp&nbsp&nbsp&nbsp- ${this.monday}: ${
        assocWorkedDay[this.mondayWorkedDay]
      }`;
      if (this.mondayComment !== null) {
        result += ` (${this.mondayComment})`;
      }
      result += `<br>&nbsp&nbsp&nbsp&nbsp- ${this.tuesday}: ${
        assocWorkedDay[this.tuesdayWorkedDay]
      }`;
      if (this.tuesdayComment !== null) {
        result += ` (${this.tuesdayComment})`;
      }
      result += `<br>&nbsp&nbsp&nbsp&nbsp- ${this.wednesday}: ${
        assocWorkedDay[this.wednesdayWorkedDay]
      }`;
      if (this.wednesdayComment !== null) {
        result += ` (${this.wednesdayComment})`;
      }
      result += `<br>&nbsp&nbsp&nbsp&nbsp- ${this.thursday}: ${
        assocWorkedDay[this.thursdayWorkedDay]
      }`;
      if (this.thursdayComment !== null) {
        result += ` (${this.thursdayComment})`;
      }
      result += `<br>&nbsp&nbsp&nbsp&nbsp- ${this.friday}: ${
        assocWorkedDay[this.fridayWorkedDay]
      }`;
      ...
      result +=
        "<br><br>Je reste à ta disposition si tu as la moindre question.<br><br>Bien à toi,<br><br>Kevin Herrbach";
      return result;
    },
    formatMailHref: function() {
      return (
        ...
        this.getBody
          ...
          .replace(/&nbsp&nbsp&nbsp&nbsp/gm, "%09")
      );
    }
  },
  methods: {
